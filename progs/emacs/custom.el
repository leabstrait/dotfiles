...
(custom-set-variables
 ...
 '(package-selected-packages
   '(company doom-themes ef-themes expand-region flycheck fzf-native
             gruvbox-theme helm hungry-delete indent-bars lsp-pyright
             lsp-ui magit-todos night-owl-theme symbol-overlay
             undo-tree vterm web-mode yafolding yasnippet-snippets)))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:background "#1a1e24" :foreground "#eeeeee"))))
 '(company-tooltip-common ((t (:foreground "#00adb5" :weight bold))))
 '(company-tooltip-scrollbar-thumb ((t (:background "#00adb5"))))
 ...
 '(helm-match ((t (:foreground "#00adb5" :weight bold))))
 '(helm-selection ((t (:background "#1b4950" :foreground "#00adb5" :weight bold))))
 '(helm-separator ((t (:foreground "#008389"))))
 '(helm-source-header ((t (:background "#222831" :foreground "#00adb5" :weight bold :height 1.1))))
 '(hl-line ((t (:background "#222831"))))
 ...
 '(symbol-overlay-default-face ((t (:background "#1b4950" :foreground "#00adb5" :weight bold))))
