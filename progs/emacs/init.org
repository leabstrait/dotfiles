# Auto tangle init.org into init.el
(#+PROPERTY: header-args:emacs-lisp :tangle ./init.el :mkdirp yes)


* required (need to lookup)
#+begin_src emacs-lisp
  ;; -*- lexical-binding: t; -*-
#+end_src

* Auto tangle init.org literate configuration
#+begin_src emacs-lisp
...
** async (only works with package.el) 
#+begin_src emacs-lisp
    (use-package async
      :defer t
      :custom
...
*** todo add keybindings for undo-fu and vundo.
